<%@ Page Title="TO Approved Report" Language="C#" MasterPageFile="~/MasterAdm.master" AutoEventWireup="true" CodeFile="AdmRptTOApprove.aspx.cs" Inherits="AdmRptTOApprove" %>
        ...
        style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
            ...
            <div align="center">
                ...
                font-size: 28px;" class="style16">
                    Time Office Approve Summary Report
                   </h1>
                </td>
                </tr>
                <tr>
