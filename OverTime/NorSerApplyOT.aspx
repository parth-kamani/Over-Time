<%@ Page Title="Apply OverTime" Language="C#" MasterPageFile="~/MasterNor.master" AutoEventWireup="true" CodeFile="NorSerApplyOT.aspx.cs" Inherits="NorSerApplyOT" %>
...
<asp:Content ID="Content2" runat="server" 
    contentplaceholderid="ContentPlaceHolder1">
        ...
        <table bgcolor="#CCCCCC" border="1px" width="100%" align="center" frame="border"
            bgcolor="#FFFFFF">
            <tr>
                <td class="style13,style16" align="left">
                            ...
                            <td class="style116" align="left">
                                <h1 align="right" style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
                                    ...
                                    <asp:DropDownList ID="DropDownList15" runat="server" AutoPostBack="True" 
                                        ...
                                        <asp:ListItem Value="29.5">05:30</asp:ListItem>
                                        <asp:ListItem Value="30">06:00</asp:ListItem>
                                        <asp:ListItem Value="30.5">06:30</asp:ListItem>
                                        <asp:ListItem Value="31">07:00</asp:ListItem>
                                        <asp:ListItem Value="31.5">07:30</asp:ListItem>
                                        <asp:ListItem Value="32">08:00</asp:ListItem>
                                        <asp:ListItem Value="32.5">08:30</asp:ListItem>
                                        <asp:ListItem Value="33">09:00</asp:ListItem>
                                        <asp:ListItem Value="33.5">09:30</asp:ListItem>
                                        <asp:ListItem Value="34">10:00</asp:ListItem>
                                        <asp:ListItem Value="34.5">10:30</asp:ListItem>
                                        <asp:ListItem Value="35">11:00</asp:ListItem>
                                        <asp:ListItem Value="35.5">11:30</asp:ListItem>
                                        <asp:ListItem Value="36">12:00</asp:ListItem>
                                        <asp:ListItem Value="36.5">12:30</asp:ListItem>
                                        <asp:ListItem Value="37">13:00</asp:ListItem>
                                        <asp:ListItem Value="37.5">13:30</asp:ListItem>
                                        <asp:ListItem Value="38">14:00</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="DropDownList16" runat="server" AutoPostBack="True" 
                                        ...
                                        <asp:ListItem Value="37.5">13:30</asp:ListItem>
                                        <asp:ListItem Value="38">14:00</asp:ListItem>
                                        <asp:ListItem Value="38.5">14:30</asp:ListItem>
                                        <asp:ListItem Value="39">15:00</asp:ListItem>
                                        <asp:ListItem Value="39.5">15:30</asp:ListItem>
                                        <asp:ListItem Value="40">16:00</asp:ListItem>
                                        <asp:ListItem Value="40.5">16:30</asp:ListItem>
                                        <asp:ListItem Value="41">17:00</asp:ListItem>
                                        <asp:ListItem Value="41.5">17:30</asp:ListItem>
                                        <asp:ListItem Value="42">18:00</asp:ListItem>
                                        <asp:ListItem Value="42.5">18:30</asp:ListItem>
                                        <asp:ListItem Value="43">19:00</asp:ListItem>
                                        <asp:ListItem Value="43.5">19:30</asp:ListItem>
                                        <asp:ListItem Value="44">20:00</asp:ListItem>
                                        <asp:ListItem Value="44.5">20:30</asp:ListItem>
                                        <asp:ListItem Value="45">21:00</asp:ListItem>
                                        <asp:ListItem Value="45.5">21:30</asp:ListItem>
                                        <asp:ListItem Value="46">22:00</asp:ListItem>
                                    </asp:DropDownList>
                           ...
                           <td class="style27" align="left">
                            ...
                            <td class="style116">
                                <asp:TextBox ID="TextBox17" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    ...
                                    Font-Size="Large" CssClass="style98" BackColor="Silver" ReadOnly="True" 
                    ...
                    <asp:ListItem> Others</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td class="style127" width="219px">
                                <asp:DropDownList ID="DropDownList5" runat="server" Width="200px" Style="text-align: center;
                                    margin-right: 0px; font-size: small;" ToolTip="Department's Section"
                                    Font-Size="Large" Font-Bold="False" Font-Names="Courier New" 
                        ...
                        <tr>
                            ...
                            <asp:Label ID="Label7" runat="server" Text="autho" Visible="False"></asp:Label>
                            </td>
                            <td class="style95">
                                <asp:Label ID="Label2" runat="server" Width="242px"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
