...
public partial class HosdRptNApprove : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        sqlDataSource.SelectCommand = "SELECT [srno], [psno], [name], [desig], [shift], [otshift], [costcentre], [area], [otentrydt], [allocation], [totalhrs], [lunchded], [assignwrk], [usrremark], [replacepsno], [replacename], [hosdapprove], [hosdremark], [toapprove], [toremark] FROM [otentrytable] WHERE ([sec] = '" + DropDownList2.SelectedItem.ToString() + "') AND ([dept] = '" + Label6.Text + "') AND ([hosdapprove] = '" + Label5.Text + "' OR [hosdapprove] =  '" + Label7.Text + "' OR [toapprove] =  '" + Label5.Text + "' OR [toapprove] =  '" + Label7.Text + "') AND ([otentrydt] BETWEEN '" + TextBox6.Text + "' AND '" + TextBox7.Text + "') ORDER BY [srno] DESC";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=NonApprovedRpt" + TextBox6.Text + "to" + TextBox7.Text + ".xls");
        Response.Charset = "";
