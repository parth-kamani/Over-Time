<%@ Page Title="Department Entry" Language="C#" MasterPageFile="~/MasterAdm.master" AutoEventWireup="true" CodeFile="AdmESerDH.aspx.cs" Inherits="AdmESerDH" %>
    ...
    contentplaceholderid="ContentPlaceHolder1">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
            ...
            <tr>
                ...
                font-variant: normal; text-transform: none; color: #102030; 
                font-size: large;" class="style16">
                    <asp:Label ID="Label3" runat="server" Text="HOD Name:"></asp:Label>
                </h1>
                </td>
                <td class="style22">
                    <asp:TextBox ID="TextBox5" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                                 Width="200px" style="text-align: center" 
                                                ToolTip="HOD's Name" Font-Size="Large" autocomplete="off"></asp:TextBox>
                </td>
                </tr>
                 <tr>
                <td class="style25" align="left">
                ...
                font-variant: normal; text-transform: none; color: #102030; 
                font-size: large;" class="style16">
                    <asp:Label ID="Label4" runat="server" Text="HOD E-Mail:"></asp:Label>
                </h1>
                </td>
                <td class="style22">
                ...
                <asp:Button ID="Button3" runat="server" Text="Delete" Font-Size="15px" Width="100px"
                    ...
                    <tr><td class="style24" colspan="2">
                        ...
                        Height="55px" DataKeyNames="dept" DataSourceID="SqlDataSourceSecShow" >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="hodname" HeaderText="hodname" 
                                SortExpression="hodname" ControlStyle-BorderWidth="2px" 
                            ...
                            <asp:BoundField DataField="hodemail" HeaderText="hodemail" 
                                SortExpression="hodemail" ControlStyle-BorderWidth="2px" 
                                FooterStyle-BorderWidth="2px" HeaderStyle-BorderWidth="2px" 
                                ItemStyle-BorderWidth="2px"/>
                        </Columns>
...
<HeaderStyle BackColor="#333333" BorderWidth="2px"></HeaderStyle>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceSecShow" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT [dept], [hodname], [hodemail] FROM [depthead] ORDER BY [srno]">
                        </asp:SqlDataSource>
                        ...
                        BorderColor="WhiteSmoke" Visible="False" 
                        style="font-family: 'Courier New'; font-weight: 700; font-size: medium" 
                        Height="55px" DataKeyNames="dept" DataSourceID="SqlDataSourceSecDept" >
...
<HeaderStyle BackColor="#333333" BorderWidth="2px"></HeaderStyle>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceSecDept" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT [dept], [hodname], [hodemail] FROM [depthead] WHERE ([dept] = @dept)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList1" Name="dept" 
                                    PropertyName="SelectedValue" Type="String" />
                            </SelectParameters>
