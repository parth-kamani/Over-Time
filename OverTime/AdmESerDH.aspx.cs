...
public partial class AdmESerDH : System.Web.UI.Page
{
   SqlConnection mssqlconn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
    ...
    /*protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            mssqlconn.Open();
            string str = "select * from depthead where dept='" + DropDownList1.SelectedValue + "'";
    ...
    protected void DropDownList1_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        //DropDownList1.Items.Insert(1, "--Add Section--");
        ...
        else
        {
            ...
            //{
                ...
                if (TextBox5.Text != null && TextBox6.Text != null)
                {
                    ...
                    mssqlconn.Open();
                    string str = "select max(srno) from depthead";
                    ...
                    string query = "insert into depthead values ('" + DropDownList1.SelectedValue + "','" + TextBox6.Text + "','" + TextBox5.Text + "')";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string query = "update depthead set hodname = '" + TextBox5.Text + "', hodemail = '" + TextBox6.Text + "' where dept='" + DropDownList1.SelectedValue + "'";
        SqlCommand cmd4 = new SqlCommand(query, mssqlconn);
        int flg = cmd4.ExecuteNonQuery();
        if (flg > 0)
        {
    ...
    {
        mssqlconn.Open();
        string str = "delete from depthead where dept='" + DropDownList1.SelectedValue + "'";
