...
public partial class AdmRptEmp : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=AdmEmpWisRptOf" + DropDownList1.SelectedItem.ToString() + ".xls");
        Response.Charset = "";
