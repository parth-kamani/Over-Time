<%@ Page Title="OT Status Report" Language="C#" MasterPageFile="~/MasterHosd.master" AutoEventWireup="true" CodeFile="HosdRptOTStatus.aspx.cs" Inherits="HosdRptOTStatus" %>
        ...
        style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
            ...
            <div align="center">
                ...
                font-size: 28px;" class="style16">
                    Approved Over Time Status Report
                   </h1>
                </td>
                </tr>
                <tr>
                ...
                <td> <asp:Button ID="Button9" runat="server" Text="Reset" Font-Size="15px" Width="150px"
                                                Font-Names="Courier New" Font-Bold="True" 
                        ToolTip="Reset" onclick="Button9_Click" AutoPostBack="True" /><br/></td><td></tr>
                <tr>
                <td class="style22">
                ...
                <td class="style22">
                    <asp:TextBox ID="TextBox1" runat="server" 
                        ...
                        type= "date" ontextchanged="TextBox1_TextChanged" Width="170px" ToolTip="Date From"></asp:TextBox>
                ...
                <h1 align="right" style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
                font-variant: normal; text-transform: none; color: #102030; 
                font-size: large; width: 31px; margin-bottom: 19px; text-align: left;" 
                        class="style16">
                    To:
                </h1>
                </td>
                <td class="style22">
                    <asp:TextBox ID="TextBox2" runat="server" 
                        style="font-size: large; font-family: 'Courier New'; text-align: center;" 
                        type= "date" ontextchanged="TextBox2_TextChanged" Width="170px" AutoPostBack ="true" ToolTip="Date To"></asp:TextBox>

                    <asp:TextBox ID="TextBox7" runat="server" Visible="False" Height="19px"></asp:TextBox>
                    
                </td>
                
                <td><asp:Button ID="Button2" runat="server" Text="Show Records" Font-Size="15px" Width="150px"
                                                Font-Names="Courier New" Font-Bold="True" 
                        ToolTip="Show Records of Department" onclick="Button2_Click" /></td>
                <td class="style22">
                <div id="sec" runat = "server" visible = "false">
                <h1 align="right" style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
                font-variant: normal; text-transform: none; color: #102030; 
                font-size: large; width: 465px; text-align: left;" class="style16">
                    Section:
