<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/MasterHosd.master" AutoEventWireup="true" CodeFile="HosdSerChangePwd.aspx.cs" Inherits="HosdSerChangePwd" %>
            ...
            <tr>
                ...
                <td class="style20">
                    <asp:TextBox ID="TextBox1" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                                ...
                                                ToolTip="PS No. Of Employee" Font-Size="Large" BackColor="Silver" 
