<%@ Page Title="TO Not-Approve Report" Language="C#" MasterPageFile="~/MasterAdm.master" AutoEventWireup="true" CodeFile="AdmRptTONApprove.aspx.cs" Inherits="AdmRptTONApprove" %>
        ...
        style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
            ...
            <div align="center">
                ...
                font-size: 28px;" class="style16">
                    Time Office Not-Approve Summary Report
                   </h1>
                </td>
                </tr>
                <tr>
