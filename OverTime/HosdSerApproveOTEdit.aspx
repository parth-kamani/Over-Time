<%@ Page Title="Edit OverTime" Language="C#" MasterPageFile="~/MasterHosd.master" AutoEventWireup="true" CodeFile="HosdSerApproveOTEdit.aspx.cs" Inherits="HosdSerApproveOTEdit" %>
            ...
            <tr>
                <td class="style13,style16" align="left">
                    <h1 align="left" style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
                        ...
                        Over Time Approve Edit Entry Form
                    </h1>
                    <table bgcolor="#CCCCCC" width="60%" align="left" style="height: 197px">
                        ...
                        <td class="style111" align="left">
                            ...
                            <asp:TextBox ID="TextBox7" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    Width="200px" Style="text-align: center; font-size: small;" ToolTip="Serial Number"
                                    Font-Size="Large" CssClass="style98" BackColor="Silver" ReadOnly="True" ></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*"
                                    ForeColor="#CC0000" ControlToValidate="TextBox7"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                            <asp:Button ID="Button1" runat="server" Text="Go Back" Font-Size="15px" Width="100px"
                                    Font-Names="Courier New" Font-Bold="True" ToolTip="Go Back" 
                                    TabIndex="16" onclick="Button1_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td class="style111" align="left">
                            ...
                            <asp:TextBox ID="TextBox6" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    Width="200px" Style="text-align: center; font-size: small;" ToolTip="Employee's PS No."
                                    Font-Size="Large" CssClass="style98" BackColor="Silver" ReadOnly="True" autocompelete="off"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                    ForeColor="#CC0000" ControlToValidate="TextBox6"></asp:RequiredFieldValidator>
                            </td>
                            ...
                            <td class="style107">
                                <asp:TextBox ID="TextBox9" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    ...
                                    Font-Size="Large" CssClass="style98" TabIndex="7" BackColor="Silver" ReadOnly="True" DataFormatString = "{0:dd/MM/yyyy}" ></asp:TextBox><%--ondayrender="Calendar1_DayRender"--%>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="*"
                                    ForeColor="#CC0000" ControlToValidate="TextBox9"></asp:RequiredFieldValidator><br/><br />
                            ...
                            <td class="style115" width="219px">
                                <asp:DropDownList ID="DropDownList7" runat="server" Width="200px" Style="text-align: center;
                                    ...
                                    onselectedindexchanged="DropDownList7_SelectedIndexChanged" BackColor="Silver" 
                        ...
                        <tr>
                            ...
                            <td class="style118" width="219px">
                                <asp:TextBox ID="TextBox3" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    Width="200px" Style="text-align: center; font-size: small;" ToolTip="Employee's Designation"
                                    Font-Size="Large" CssClass="style98" BackColor="Silver" ReadOnly="True" autocompelete="off"></asp:TextBox>
                                ...
                                <h1 align="right" style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
                                    ...
                                    text-align: left; width: 229px;" class="style30">
                                     <asp:DropDownList ID="DropDownList3" runat="server" Width="70px" Style="text-align: center;
                                        ...
                                        AutoPostBack="True" class="style130" Visible="False" BackColor="Silver" 
                                    ...
                                    <asp:DropDownList ID="DropDownList2" runat="server" Width="70px" Style="text-align: center;
                                        ...
                                        onselectedindexchanged="DropDownList2_SelectedIndexChanged" BackColor="Silver">
                                        <asp:ListItem Value= "14">14:00</asp:ListItem>
                                    ...
                                    <asp:DropDownList ID="DropDownList14" runat="server" Width="70px" Style="text-align: center;
                                        font-size: small;" ToolTip="Employee's O.T Start Time" Font-Size="Large" Font-Bold="False"
                                        Font-Names="Courier New" CssClass="style28" TabIndex="11" 
                                        AutoPostBack="True" class="style130" Height="16px" BackColor="Silver"
                                    ...
                                    <asp:DropDownList ID="DropDownList4" runat="server" AutoPostBack="True" 
                                        ...
                                        Visible="False" Width="70px" BackColor="Silver">
                                        <asp:ListItem Value="6">06:00</asp:ListItem>
                                        <asp:ListItem Value="6.5">06:30</asp:ListItem>
                                        <asp:ListItem Value="7">07:00</asp:ListItem>
                                        <asp:ListItem Value="7.5">07:30</asp:ListItem>
                        ...
                        <td class="style111" align="left">
                            ...
                            <td class="style125">
                                <asp:DropDownList ID="DropDownList9" runat="server" Width="200px" Style="text-align: center;
                                    margin-right: 0px; font-size: small;" ToolTip="Employee's Correct Lunch Deduction"
                                    Font-Size="Large" Font-Bold="False" Font-Names="Courier New" 
                                    CssClass="style28" TabIndex="13" AutoPostBack="True" BackColor="Silver"
                            ...
                            <td colspan="2" rowspan="8">
                                <img class="style91" src="images/ts-slider-img2.png" />
                            </td>
                        </tr>
                        <tr>
                            <td class="style111" align="left">
                    ...
                    <asp:ListItem> Others</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td class="style125">
                                <asp:TextBox ID="TextBox11" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    ...
                                    Font-Size="Large" CssClass="style28" TabIndex="14" TextMode="MultiLine" BackColor="Silver" ReadOnly="true"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="style116">
                                <asp:TextBox ID="TextBox2" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    ...
                                    Font-Size="Large" CssClass="style28" TabIndex="15" TextMode="MultiLine" BackColor="Silver" ReadOnly="true"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <asp:TextBox ID="TextBox8" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    Width="200px" Style="text-align: center; font-size: small;" ToolTip="Department's Section"
                                    Font-Size="Large" CssClass="style98" BackColor="Silver" ReadOnly="True" autocompelete="off"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*"
                                    ForeColor="#CC0000" ControlToValidate="TextBox8"></asp:RequiredFieldValidator>
                            </td>
                            <td class="style122" align="left">
                                <h1 align="right" style="font-family: 'Courier New'; font-weight: bold; font-style: normal;
                                    font-variant: normal; text-transform: none; color: #102030;" class="style29">
                        ...
                        <tr>
                            ...
                            <td class="style118" width="219px">
                                <asp:DropDownList ID="DropDownList6" runat="server" Width="200px" Style="text-align: center;
                                    ...
                                    DataTextField="area" DataValueField="area" AppendDataBoundItems="true" BackColor="Silver" AutoPostBack="true">
                                    <asp:ListItem></asp:ListItem>
                            ...
                            <td class="style116">
                                <asp:TextBox ID="TextBox10" runat="server" BorderStyle="Inset" Font-Names="Bookman Old Style"
                                    Width="200px" Style="text-align: center; font-size: small;" ToolTip="HOD/HOS Remark"
                                    Font-Size="Large" CssClass="style28" TabIndex="15" TextMode="MultiLine" ></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="style103" width="219px">
                                <asp:Label ID="Label1" runat="server" Width="242px"></asp:Label>
                            </td>
                            <td class="style94">
                            ...
                            <td class="style95">
                                <asp:Label ID="Label2" runat="server" Width="242px" Text="N" Visible= "false"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    </ContentTemplate>
