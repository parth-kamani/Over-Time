...
public partial class AdmRptPMnt : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        if (DropDownList5.SelectedIndex != 0 && DropDownList6.SelectedIndex != 0)
        {
            if (Convert.ToInt32(Label4.Text) <= DateTime.Today.Year)
            {
                ...
                sqlDataSource.SelectCommand = "SELECT [psno], [name], [dept], [sec], SUM([totalhrs]) AS [totalhrs] FROM otentrytable WHERE [toamnt]='" + DropDownList2.SelectedValue.ToString() + "' AND [toayear]='" + Label8.Text + "' AND ([otentrydt])BETWEEN '" + str + "' AND '" + str1 + "' AND [toapprove]='" + Label5.Text + "' AND [dept]='" + DropDownList5.SelectedValue.ToString() + "' AND [sec]='" + DropDownList6.SelectedValue.ToString() + "' AND [previousot]='" + Label7.Text + "' GROUP BY [psno],[name],[dept],[sec] ORDER BY [psno] ASC";
        ...
        else if (DropDownList5.SelectedIndex != 0)
        {
            if (Convert.ToInt32(Label4.Text) <= DateTime.Today.Year)
            {
                ...
                Label4.Text = DropDownList1.SelectedValue.ToString();
                // Retrieve records with only 5 Columns from Employees table of NorthWind Database.
                sqlDataSource.SelectCommand = "SELECT [psno], [name], [dept], [sec], SUM([totalhrs]) AS [totalhrs] FROM otentrytable WHERE [toamnt]='" + DropDownList2.SelectedValue.ToString() + "' AND [toayear]='" + Label8.Text + "' AND ([otentrydt])BETWEEN '" + str + "' AND '" + str1 + "' AND [toapprove]='" + Label5.Text + "' AND [dept]='" + DropDownList5.SelectedValue.ToString() + "' AND [previousot]='" + Label7.Text + "' GROUP BY [psno],[name],[dept],[sec] ORDER BY [psno] ASC";                
                // Bind SQLDataSource to GridView after retrieving the records.
                GridView1.DataSource = sqlDataSource;
                GridView1.DataBind();
                GridView1.Visible = true;
        ...
        else if (DropDownList5.SelectedIndex == 0 && DropDownList6.SelectedIndex == 0)
        {
            if (Convert.ToInt32(Label4.Text) <= DateTime.Today.Year)
            {
                ...
                Label4.Text = DropDownList1.SelectedValue.ToString();
                // Retrieve records with only 5 Columns from Employees table of NorthWind Database.
                sqlDataSource.SelectCommand = "SELECT [psno], [name], [dept], [sec], SUM([totalhrs]) AS [totalhrs] FROM otentrytable WHERE [toamnt]='" + DropDownList2.SelectedValue.ToString() + "' AND [toayear]='" + Label8.Text + "' AND ([otentrydt])BETWEEN '" + str + "' AND '" + str1 + "' AND [toapprove]='" + Label5.Text + "' AND [previousot]='" + Label7.Text + "' GROUP BY [psno],[name],[dept],[sec] ORDER BY [psno] ASC";                
                // Bind SQLDataSource to GridView after retrieving the records.
                GridView1.DataSource = sqlDataSource;
                GridView1.DataBind();
                GridView1.Visible = true;
    ...
    private void BindGrid1()
    {
        ...
        if (DropDownList5.SelectedIndex != 0 && DropDownList6.SelectedIndex != 0)
        {
            if (Convert.ToInt32(Label4.Text) <= DateTime.Today.Year)
            {
                ...
                Label4.Text = DropDownList1.SelectedValue.ToString();
                // Retrieve records with only 5 Columns from Employees table of NorthWind Database.
                sqlDataSource.SelectCommand = "SELECT [psno], [name], [dept], [sec], SUM([totalhrs]) AS [totalhrs] FROM otentrytable WHERE [toamnt]='" + DropDownList2.SelectedValue.ToString() + "' AND [toayear]='" + Label8.Text + "' AND ([otentrydt])BETWEEN '" + str + "' AND '" + str1 + "' AND [toapprove]='" + Label5.Text + "' AND [dept]='" + DropDownList5.SelectedValue.ToString() + "' AND [sec]='" + DropDownList6.SelectedValue.ToString() + "' AND [previousot]='" + Label5.Text + "' GROUP BY [psno],[name],[dept],[sec] ORDER BY [psno] ASC";
                // Bind SQLDataSource to GridView after retrieving the records.
                GridView1.DataSource = sqlDataSource;
                GridView1.DataBind();
                GridView1.Visible = true;
        ...
        else if (DropDownList5.SelectedIndex != 0)
        {
            if (Convert.ToInt32(Label4.Text) <= DateTime.Today.Year)
            {
                ...
                Label4.Text = DropDownList1.SelectedValue.ToString();
                // Retrieve records with only 5 Columns from Employees table of NorthWind Database.
                sqlDataSource.SelectCommand = "SELECT [psno], [name], [dept], [sec], SUM([totalhrs]) AS [totalhrs] FROM otentrytable WHERE [toamnt]='" + DropDownList2.SelectedValue.ToString() + "' AND [toayear]='" + Label8.Text + "' AND ([otentrydt])BETWEEN '" + str + "' AND '" + str1 + "' AND [toapprove]='" + Label5.Text + "' AND [dept]='" + DropDownList5.SelectedValue.ToString() + "' AND [previousot]='" + Label5.Text + "' GROUP BY [psno],[name],[dept],[sec] ORDER BY [psno] ASC";                
                // Bind SQLDataSource to GridView after retrieving the records.
                GridView1.DataSource = sqlDataSource;
                GridView1.DataBind();
                GridView1.Visible = true;
        ...
        else if (DropDownList5.SelectedIndex == 0 && DropDownList6.SelectedIndex == 0)
        {
            if (Convert.ToInt32(Label4.Text) <= DateTime.Today.Year)
            {
                ...
                Label4.Text = DropDownList1.SelectedValue.ToString();
                // Retrieve records with only 5 Columns from Employees table of NorthWind Database.
                sqlDataSource.SelectCommand = "SELECT [psno], [name], [dept], [sec], SUM([totalhrs]) AS [totalhrs] FROM otentrytable WHERE [toamnt]='" + DropDownList2.SelectedValue.ToString() + "' AND [toayear]='" + Label8.Text + "' AND ([otentrydt])BETWEEN '" + str + "' AND '" + str1 + "' AND [toapprove]='" + Label5.Text + "' AND [previousot]='" + Label5.Text + "' GROUP BY [psno],[name],[dept],[sec] ORDER BY [psno] ASC";                
                // Bind SQLDataSource to GridView after retrieving the records.
                GridView1.DataSource = sqlDataSource;
                GridView1.DataBind();
                GridView1.Visible = true;
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=AdmPaidMntRptOf" + DropDownList5.SelectedItem.ToString() + "OfCurrRpt.xls");
        Response.Charset = "";
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=AdmPaidMntRptOf" + DropDownList5.SelectedItem.ToString() + "OfPrevRpt.xls");
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        using (StringWriter sw = new StringWriter())
        {
