<%@ Page Title="Home" Language="C#" MasterPageFile="~/MasterHome.master" AutoEventWireup="true" CodeFile="HosdHome.aspx.cs" Inherits="HosdHome" %>
            ...
            <tr>
                ...
                font-variant: normal; text-transform: none; color: #102030; font-size: 28px;" >
                            ...
                            zero water discharge and zero ground water usage...<asp:HyperLink 
                                ID="HyperLink1" runat="server" Font-Italic="True" ForeColor="#CC0000" NavigateUrl="~/HosdAbout.aspx">Read More</asp:HyperLink>
                                    </span>
                                </p>
                            </td>
                        </tr>
